        ...
        <div v-if="tab === 'compare'" class="card">
          <div class="compare-pickers">
            <div class="compare-pick">
              ...
              <el-select v-model="compareLeft" :placeholder="t('evalLab.ph_runA')" style="max-max-width: 360px; width: 100%; width: 100%">
                <el-option
            ...
            <div class="compare-pick">
              ...
              <el-select v-model="compareRight" :placeholder="t('evalLab.ph_runB')" style="max-max-width: 360px; width: 100%; width: 100%">
                <el-option
                  v-for="r in filteredRuns.filter((x) => x.status === 'completed')"
                  :key="r.id"
                  :label="`${r.label}  (${fmtPct(r.avg_score)})`"
