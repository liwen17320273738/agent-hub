          ...
          <div v-else>
            ...
            <div v-for="sig in stageSignals" :key="sig.id" class="signal-card">
              ...
              <div v-if="sig.reviewer_feedback" class="signal-body">
                <span class="signal-label">{{ $t('insightsObservability.reviewer') }}：</span>{{ sig.reviewer_feedback }}
              </div>
              <div v-if="sig.error_excerpt" class="signal-body danger">
                <span class="signal-label">{{ $t('insightsObservability.error') }}：</span>{{ sig.error_excerpt }}
              </div>
            </div>
          </div>
        </el-drawer>
...
<style scoped>
@import "./InsightsObservability.css";
</style>
