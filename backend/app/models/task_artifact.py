...
BUILTIN_ARTIFACT_TYPES = [
    ...
    {"type_key": "ui_mockup",          "category": "image",    "display_name": "UI 设计稿",   "icon": "🖼️", "tab_group": "design",       "sort_order": 2},
    {"type_key": "ui_mockup_html",     "category": "code",     "display_name": "UI 可交互原型", "icon": "🖌️", "tab_group": "design",       "sort_order": 2},
    {"type_key": "architecture",           "category": "document", "display_name": "技术方案",        "icon": "🏗️", "tab_group": "technical",    "sort_order": 3},
    {"type_key": "architecture_diagram",   "category": "diagram",  "display_name": "架构图",          "icon": "📐", "tab_group": "technical",    "sort_order": 3},
